...
fn get_model_registry() -> Vec<(&'static str, &'static str, &'static str, &'static str, &'static str, &'static str)> {
    vec![
        ...
        ("tdt-1.1b-q4", "English Parakeet TDT 1.1B (Q4)", "tdt-1.1b-q4_k_m.gguf",
         "https://huggingface.co/mudler/parakeet-cpp-gguf/resolve/main/tdt-1.1b-q4_k_m.gguf",
        ...
        ("rnnt-1.1b-q4", "Multilingual Parakeet RNNT 1.1B (Q4)", "rnnt-1.1b-q4_k_m.gguf",
         "https://huggingface.co/mudler/parakeet-cpp-gguf/resolve/main/rnnt-1.1b-q4_k_m.gguf",
